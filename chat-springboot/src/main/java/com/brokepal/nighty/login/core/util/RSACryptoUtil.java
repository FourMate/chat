...
public class RSACryptoUtil {
    ...
    public static KeyPairOfString makeBothKeyOfString() throws NoSuchAlgorithmException {
        ...
        String publicKey = Base64Util.encode(rsaPublicKey.getEncoded());
        String privateKey = Base64Util.encode(rsaPrivateKey.getEncoded());
...
//        com.sun.org.apache.xml.internal.security.Init.init();
        ...
        String cryptograph = Base64Util.encode(RSACryptograph);
        return cryptograph;
    }
    /**
     * 私钥解密
...
//        com.sun.org.apache.xml.internal.security.Init.init();
        byte[] RSACryptograph = Base64Util.decode(cryptograph);
